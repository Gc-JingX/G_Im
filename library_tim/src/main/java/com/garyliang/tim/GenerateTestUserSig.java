...
public class GenerateTestUserSig {
     ...
     * 它是腾讯云用于区分客户的唯一标识。
     */
    public static final int SDKAPPID = 1400287870;

    public static final String DEFAULT_GROUPID = "@TGS#2FOQGMCGE";
     ...
     */
    private static final String SECRETKEY = "afaa157cf0f312730f2f1d142fd2350f899e6642a53f317c3135005e821f44f8";
    ...
    private static String genTLSSignature(long sdkappid, String userId, long expire, byte[] userbuf, String priKeyContent) {
        ...
        compressor.setInput(sigDoc.toString().getBytes(Charset.forName(UTF_8)));
        compressor.finish();
    ...
    private static String hmacsha256(long sdkappid, String userId, long currTime, long expire, String priKeyContent, String base64Userbuf) {
        ...
        try {
            byte[] byteKey = priKeyContent.getBytes(UTF_8);
            Mac hmac = Mac.getInstance("HmacSHA256");
            SecretKeySpec keySpec = new SecretKeySpec(byteKey, "HmacSHA256");
            hmac.init(keySpec);
            byte[] byteSig = hmac.doFinal(contentToBeSigned.getBytes(UTF_8));
