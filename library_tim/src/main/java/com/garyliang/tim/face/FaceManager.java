...
public class FaceManager {
    ...
    private static final int DRAWABLE_WIDTH = ScreenUtil.getPxByDp(32);
    ...
    private static List<FaceGroup> customFace = new ArrayList<>();
    ...
    private static Emoji loadAssetBitmap(String filter, String assetPath, boolean isEmoji) {
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeStream(is, new Rect(0, 0, DRAWABLE_WIDTH, DRAWABLE_WIDTH), options);
            if (bitmap != null) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                for (int i = 0; i < groups.size(); i++) {
                    ...
                    Emoji emoji2 = loadAssetBitmap(groupConfigs.getFaceIconName(), groupConfigs.getFaceIconPath(), false);

                    groupInfo.setGroupIcon(emoji2 == null ? null : emoji2.getIcon());


                    List<CustomFace> customFaceArray = groupConfigs.getCustomFaceList();
                    List<Emoji> faceList = new ArrayList<>();
