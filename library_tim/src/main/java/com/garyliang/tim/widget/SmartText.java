 ...
 * </pre>
 */
public class SmartText extends androidx.appcompat.widget.AppCompatTextView {
    /**
     * <pre>
     *     desc   :  ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ :   desc
     *     desc   :                                                                           :   desc
...
//        storeTv.display();
    ...
    public SmartText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SmartText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        SmartText.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }
