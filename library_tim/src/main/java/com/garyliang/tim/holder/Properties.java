...
import com.garyliang.tim.impl.IMessageProperties;
import com.garyliang.tim.util.ScreenUtil;

public class Properties implements IMessageProperties {

    private static Properties sP = new Properties();
    private int mAvatarId;
    private int mAvatarRadius = ScreenUtil.getPxByDp(30);
