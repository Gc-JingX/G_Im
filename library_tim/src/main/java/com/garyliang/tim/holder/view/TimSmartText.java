package com.garyliang.tim.holder.view;
 ...
 * </pre>
 */
public class TimSmartText extends androidx.appcompat.widget.AppCompatTextView {
    /**
     * <pre>
     *     desc   :  ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ ☆ :   desc
     *     desc   :                                                                           :   desc
     ...
     */
//storeTv.reset();
//        storeTv.addPiece(new SmartText.Piece.Builder(ResUtil.getString(R.string.main_store_car_1))
//            .textColor(Color.parseColor("#333333"))
//            .textSize(DisUtil.dpToSp(14))
//            .build());
//        storeTv.addPiece(new SmartText.Piece.Builder("¥")
//                .textColor(Color.parseColor("#333333"))
//            .textSize(DisUtil.dpToSp(14))
//            .build());
//
//        storeTv.addPiece(new SmartText.Piece.Builder(PriceUtils.formatPrice(adapter.getCheckedMoney()) + "")
//                .textColor(Color.parseColor("#333333"))
//            .textSize(DisUtil.dpToSp(14))
//            .build());
//
...
//        storeTv.display();
    ...
    private static float defaultRelativeTextSize = 1;
     ...
     * @param context
     */
    public TimSmartText(Context context) {
        super(context);
        init();
    }

    public TimSmartText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TimSmartText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        TimSmartText.defaultAbsoluteTextSize = (int) getTextSize();
    }

    /**
     * Use this method to add a {@link Piece} to a SmartText.
     ...
     * SmartText to display "Hello World" such that "Hello" is displayed in Bold and "World" is
    ...
    public static class Piece {
         ...
         * displayed. After doing so, you MUST call {@code display()} for the changes to show up.
         *
         * @param (it is NOT android Color resources ID,use getResources().getColor(R.color.colorId) for it)
         */
        ...
        public static class Builder {
            ...
            // optional
            private int textSize = defaultAbsoluteTextSize;
            private int textColor = Color.BLACK;
            private int backgroundColor = -1;
            private float textSizeRelative = defaultRelativeTextSize;
